...
class NewsSpider(CrawlSpider):
    ...
    def start_requests(self):
        urls_folder_path = '/Users/achain/Documents/github/bert_classification_new/url_tot'
        ...
        for filename in os.listdir(urls_folder_path):
            if filename.endswith('.txt'):
                ...
                with open(file_path, 'r') as urls_file:
                    ...
                    if prefix:
                        save_path = os.path.join('/Users/achain/Documents/github/bert_classification_new/pages', prefix)
