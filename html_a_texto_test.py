...
DIR_BASE_CATEGORIAS = '/Users/achain/Documents/github/web-mining/pages/el-mun'
        ...
        try:
            with open(path_completo_html, "r", encoding="UTF-8") as file:
                ...
                if texto is not None:
                    htmls.append(texto)
                    with open('/Users/achain/Documents/github/web-mining/pages/el-mun_content_plain/{}.txt'.format(archivo_html), 'w', encoding='utf-8') as file:
