...
for category in categories:
    ...
    DIR_BASE_CATEGORIAS = f'/Users/achain/Documents/github/web-mining/pages/{category}'
            ...
            try:
                with open(path_completo_html, "r", encoding="UTF-8") as file:
                    ...
                    if texto is not None:
                        htmls.append(texto)
                        with open(f'/Users/achain/Documents/github/web-mining/pages/{category}_content_plain/{date_published}{archivo_html}.txt', 'w', encoding='utf-8') as file:
